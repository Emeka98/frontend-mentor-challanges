      ...
      <div className="flex flex-col gap-8 md:gap-10 justify-center items-center w-full max-w-[460px] h-full ">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex bg-dark-navy p-[9px] rounded-[10px]">
              <button
                ...
                className={`flex-1 ${
                  playerOneMark === "x" ? "bg-silver" : "bg-transparent"
                }  inline-flex justify-center items-center py-[11px] rounded-[10px] `}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="32"
              ...
              <button
                ...
                className={`flex-1 bg-silver inline-flex justify-center items-center py-[11px] rounded-[10px] ${
                  playerOneMark === "o" ? "bg-silver" : "bg-transparent"
                } `}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="flex flex-col gap-5 w-full">
          <div className="h-[67px]">
            <Button onClick={() => setIsCpu(true)} variant="primary">
              <Link to={"/game"}>New Game(VS CPU)</Link>
            </Button>
          </div>
          <div className="h-[67px]">
            <Button onClick={() => setIsCpu(false)} variant="secondary">
