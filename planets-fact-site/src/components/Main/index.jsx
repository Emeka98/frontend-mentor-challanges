  ...
  return (
    <main className="px-6">
      ...
      <div className="w-full flex justify-center mt-24 md:mt-[146px]">
        <div className="w-[111px] h-[111px] md:w-[184px] md:h-[184px]">
          <img src={data[0].images.planet} alt={`${data[0].name} image`} />
        </div>
      </div>
      {/* Main Content */}
      <div className="flex flex-col md:flex-row gap-24 md:gap-[69px] w-full items-center mt-24 md:mt-[130px] ">
        ...
        <div className="flex-1 max-w-[281px] flex-col gap-4 hidden md:flex">
