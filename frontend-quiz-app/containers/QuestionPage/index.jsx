    ...
    <div>
      <div className="flex flex-col">
        ...
        <div className="flex flex-col gap-3">
          {options.map((e, i) => (
            <Option optionType={i} option={e} />
          ))}
          <button className="w-full h-[56px] bg-purple shadow-lg rounded-xl inline-flex items-center justify-center text-white text-[18px] font-medium leading-7 ">
            Next Question
          </button>
        </div>
      </div>
