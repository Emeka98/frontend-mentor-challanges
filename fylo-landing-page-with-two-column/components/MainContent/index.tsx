...
function MainContent() {
  return (
    <main className="">
      ...
      <section className="flex flex-col gap-10 mt-[100px] md:mt-[180px] bg-[#F8F8FE] relative py-[90px] px-6">
        ...
        <div className="flex flex-col gap-6">
          <h3 className="text-[#07043B] text-center  font-semibold text-base leading-6">
            Stay productive, wherever you are
          </h3>
          <div className="flex flex-col gap-4 items-center ">
            <p className="text-[#615f7e] text-center text-sm leading-5">
          ...
          <div className="bg-white px-6 mx-6 py-5 mt-10">
