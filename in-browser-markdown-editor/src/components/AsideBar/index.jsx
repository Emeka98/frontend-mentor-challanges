  ...
  return (
    ...
    >
      <div className="w-full h-full px-6 pt-[27px] pb-8 flex flex-col">
        ...
        <button className="inline-flex w-full h-10 justify-center items-center bg-orange hover:bg-orange-hover text-white font-normal text-[15px] font-roboto leading-normal rounded mt-[29px]">
          + New Document
        </button>
